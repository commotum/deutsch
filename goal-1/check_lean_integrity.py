...
REQUIRED_PRODUCTION_IMPORT_CLOSURE = {
    ...
    "Deutsch/Information.lean": (
        ...
        "Deutsch.Information.Purification",
    ...
    "Deutsch/Information/Purification.lean": (
        "Deutsch.Information.Reduction",
        "Mathlib.Analysis.SpecialFunctions.ContinuousFunctionalCalculus.Rpow.Basic",
    ),
    "Deutsch/EPR/Entanglement.lean": (
        "Deutsch.EPR.Statistics",
    ...
    "Deutsch/Teleportation/ChannelBridge.lean": (
        "Deutsch.Teleportation.Correctness",
        "Deutsch.Teleportation.Protocol",
...
REQUIRED_INFORMATION_ORACLES = (
    ...
    "every_density_has_normalized_explicit_purification",
    "explicit_purification_reduces_to_original_copy",
    "explicit_purification_reduces_exactly_on_original_labels",
    "explicit_purification_preserves_every_embedded_prediction",
    "every_density_has_enlarged_unitary_preparation",
    "every_density_has_enlarged_fixed_reference_predictions",
    "maximally_mixed_has_enlarged_fixed_reference_predictions",
...
REQUIRED_INFORMATION_PUBLIC_DECLARATIONS = {
    ...
    "Deutsch/Information/Purification.lean": (
        "Density.reindex",
        "Density.reindex_op",
        "Density.reindex_symm_reindex",
        "densityExpectation_reindex",
        "PurificationRegister",
        "purificationOriginalPlacement",
        "purificationCopyPlacement",
        "purificationOriginalQubits",
        "purificationBasisEquiv",
        "purificationCopy_not_mem_originalQubits",
        "purificationCopyComplementEquiv",
        "purificationCopyBasisEquiv",
        "purificationOriginalDensity",
        "purificationOriginalDensity_op",
        "densitySquareRoot",
        "densitySquareRoot_posSemidef",
        "densitySquareRoot_isHermitian",
        "densitySquareRoot_mul_self",
        "purificationCoordinates",
        "purificationCoordinates_dot_star",
        "purificationKet",
        "purificationKet_norm",
        "purificationPureState",
        "purification_reduce_original",
        "purificationReducedDensity",
        "purificationReducedDensity_eq",
        "purification_embedded_expectation",
        "exists_unitary_preparation_purification",
        "exists_purification_fixed_reference_representation",
    ),
    "Deutsch/Information/Channel.lean": (
...
REQUIRED_EPR_ORACLES = (
    ...
    "product_operator_has_the_required_zero_minor",
    "every_rotated_epr_circuit_ket_is_nonproduct",
    "every_rotated_epr_circuit_pure_state_is_entangled",
    "every_rotated_epr_circuit_density_is_nonproduct",
    "prepared_epr_resource_density_is_nonproduct",
...
REQUIRED_EPR_PUBLIC_DECLARATIONS = {
    ...
    "Deutsch/EPR/Entanglement.lean": (
        "oneQubitBits",
        "IsProductKet",
        "IsEntangledPureState",
        "twoQubitProductOperator",
        "IsProductOperator",
        "IsProductDensity",
        "IsProductDensity.isProductOperator",
        "IsProductKet.amplitude_minor",
        "IsProductOperator.row_minor",
        "IsProductDensity.row_minor",
        "pairPureState_amplitude_determinant",
        "pairPureState_not_product",
        "pairPureState_isEntangled",
        "pairDensity_not_product",
...
REQUIRED_TELEPORTATION_ORACLES = (
    ...
    "literal_channel_kraus_is_a_coherentProtocol_matrix_slice",
    "literal_channel_is_reindexed_identity_on_every_operator",
    "literal_channel_is_receiver_reduction_of_five_wire_output",
    "literal_channel_is_reindexed_identity_on_every_density",
    "literal_channel_preserves_every_effect_probability",
    "literal_channel_agrees_on_every_physical_receiver_effect",
    "literal_and_semantic_channels_agree_on_every_operator",
    "literal_and_semantic_channels_agree_on_every_density",
...
REQUIRED_TELEPORTATION_PUBLIC_DECLARATIONS = {
    ...
    "Deutsch/Teleportation/ChannelBridge.lean": (
        "messageReceiverBasisEquiv",
        "reindexMessageOperator",
        "coherentProtocolInputBasis",
        "coherentProtocolOutputBasis",
        "coherentProtocolKraus",
        "messageReceiverIsometry",
        "messageReceiverIsometry_conjTranspose",
        "messageReceiverIsometry_conjTranspose_mul",
        "messageReceiverIsometry_mapOperator",
        "coherentProtocolKraus_eq",
        "fixedJunkKet_probability_normalized",
        "coherentProtocolChannel",
        "coherentProtocolChannel_mapOperator",
        "reindexMessageOperator_posSemidef",
        "reindexMessageOperator_trace",
        "reindexMessageDensity",
        "coherentProtocolChannel_mapDensity",
        "reindexMessageEffect",
        "reindexMessageDensity_op",
        "reindexMessageEffect_op",
        "bornWeight_reindexMessage",
        "coherentProtocolChannel_preserves_all_effects",
        "coherentProtocolChannel_agrees_on_every_receiver_effect",
        "coherentProtocolChannel_eq_protocolDecoder_encoder_mapOperator",
        "coherentProtocolChannel_eq_protocolDecoder_encoder_mapDensity",
        "coherentProtocolFiveWireOutputOperator",
        "coherentProtocolChannel_mapOperator_eq_receiverPartialTrace",
    ),
    "Deutsch/Teleportation/Protocol.lean": (
